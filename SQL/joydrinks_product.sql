...
CREATE TABLE `product` (
  ...
  `capacityType` varchar(45) DEFAULT NULL,
  `sugarLevel` varchar(45) DEFAULT NULL,
  `iceLevel` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `product` VALUES (1,'拿鐵','精緻','甜度','冷熱飲'),(2,'伯爵奶茶','標準','甜度','冷熱飲'),(3,'伯爵紅茶','標準','甜度','冷熱飲'),(4,'烏龍茶','標準','無糖','冷熱飲');
